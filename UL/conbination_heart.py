...
def generate_silhoutte_score_plot(X, k, model):
    ...
    plt.ylabel("Score")
    name = "output6/" + model.__name__ + " k=" + str(k) + ".jpg"
    plt.savefig(name)
    plt.cla()
...
def k_means(str1, str2, X, y_train):
    ...
    plt.ylabel('WCSS')
    name = "output6/" + str1 + " k-mean default on " + str2 + ".jpg"
    plt.savefig(name)
    plt.cla()
    # 10
    ...
    range_n_clusters = [3, 4, 5, 23, 24, 25, 26, 27, 28, 29]
...
def EM(str1, str2, X, y_train):
    ...
    name = "output6/" + str1 + " EM Cluster on " + str2 + ".jpg"
    plt.savefig(name)
    plt.cla()
    print(clf)
...
def pca(x_train, x_test):
    ...
    plt.title("Component-wise and Cumulative Explained Variance on Heart disease dataset")
    plt.xlabel('number of components')
    plt.ylabel('cumulative explained variance')
    plt.savefig("output6/PCA.jpg")
    plt.cla()
    # n= 5
    ...
    plt.savefig("output6/PCA Reconstruction Error.jpg")
    plt.cla()
    ...
    plt.savefig("output6/PCA Components.jpg")
    plt.cla()
...
def run_ICA(X, title):
    ...
    plt.grid(False)
    plt.savefig("output6/ICA.jpg")
    plt.cla()


def ICA(x_train, x_test):
    print("this is ICA")
    run_ICA(x_train, "ICA: Heart disease Dataset Average Kurtosis")
    ...
    plt.figure(figsize=(6, 4))
    plt.title('ICA Components on Heart disease dataset')
    ...
    plt.savefig("output6/ICA Components.jpg")
    plt.cla()
...
def RP(x_train, x_test):
    ...
    plt.savefig("output6/RP Reconstruction error.jpg")
    plt.cla()
    ...
    plt.savefig("output6/RP Components error.jpg")
    plt.cla()
    ...
    # RECONSTRUCTION ERROR
    rp = random_projection.GaussianRandomProjection(n_components=11)
...
def SVD(x_train, x_test):
    ...
    plt.step(range(1, len(X_tsvd.explained_variance_ratio_) + 1), np.cumsum(X_tsvd.explained_variance_ratio_),
             label='Cumulative explained variance')
    plt.title("SVD Component-wise and Cumulative Explained Variance on Heart disease data")
    plt.xlabel('number of components')
    plt.ylabel('cumulative explained variance')
    plt.savefig("output6/SVD.jpg")
    plt.cla()
    ...
    plt.ylabel('Reconstruction Error')
    plt.title('Reconstruction error for n_components chosen')
    plt.savefig("output6/SVD Reconstruction error.jpg")
    plt.cla()
    ...
    plt.figure(figsize=(6, 4))
    plt.title('SVD Components on Heart disease dataset')
    ...
    plt.savefig("output6/SVD Components.jpg")
    plt.cla()
...
if __name__ == '__main__':
    ...
    # # k_means("PCA", "Heart disease", x_pca, y_train)
    # EM("PCA", "Heart disease", x_pca, y_train)
    #
    # x_ica = ICA(x_train, x_test)
    # # k_means("ICA", "Heart disease", x_ica, y_train)
    # EM("ICA", "Heart disease", x_ica, y_train)
    #
    # x_rp = RP(x_train, x_test)
    # # k_means("RP", "Heart disease", x_rp, y_train)
    # EM("RP", "Heart disease", x_rp, y_train)
    #
    x_svd = SVD(x_train, x_test)
    # k_means("SVD", "Heart disease", x_svd, y_train)
    EM("SVD", "Heart disease", x_svd, y_train)
