...
def generate_silhoutte_score_plot(X, k, model):
    ...
    plt.ylabel("Score")
    name = "output4/" + model.__name__ + " k=" + str(k) + ".jpg"
    plt.savefig(name)
    plt.cla()
...
def pca(x_train, x_test):
    ...
    plt.savefig("output4/PCA.jpg")
    plt.cla()

    n_components = [7, 8, 9, 10, 11, 12, 13]
    ...
    plt.savefig("output4/PCA Reconstruction Error.jpg")
    plt.cla()
    ...
    plt.savefig("output4/PCA Components.jpg")
    plt.cla()
...
def ICA(x_train, x_test):
    ...
    plt.savefig("output4/ICA Components.jpg")
    plt.cla()
...
def RP(x_train, x_test):
    ...
    plt.savefig("output4/RP Reconstruction error.jpg")
    plt.cla()
    ...
    plt.savefig("output4/RP Components error.jpg")
    plt.cla()
...
def SVD(x_train, x_test):
    ...
    plt.ylabel('Reconstruction Error')
    plt.title('Reconstruction error for n_components chosen')
    plt.savefig("output4/SVD Reconstruction error.jpg")
    plt.cla()
    ...
    plt.savefig("output4/SVD Components.jpg")
    plt.cla()
